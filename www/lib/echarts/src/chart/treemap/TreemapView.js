 define(function(require) {
    ...
    return require('../../echarts').extendChartView({
        ...
        _doRender: function (containerGroup, seriesModel, reRoot) {
            ...
            // elements from tree. So we use this stragegy: make element localData, move
            // from old localData to new localData, clear old localData.
    ...
    function renderNode(
        ...
        if (!thisNode) {
            ...
            // element from old localData, or create new element, set them to new
            // localData, and set styles.
            return;
        }
